       ...
       author. Grupo 04: Alexsandro Neri, Brunno Melo, Henrique Lino,
               Reginaldo Luiz, Rômulo Vannuchi e Walter Chamorro.

       date-written. 02/04/2018.

      ******************************************************************
      *1) Programa Aula4 - Calcular a média aritmética das notas
      ...
      ******************************************************************
      *No working-storage section. É o lugar onde vamos criar as
      *                            variáveis e constantes.
      ******************************************************************
       working-storage section.

       01 Dados.
               02 Nome-Aluno           PIC X(20)    VALUE SPACES.
      ...
      ******************************************************************
      *No screen section. É o lugar onde definimos as telas usadas
      *                   no programa.
      ******************************************************************
       screen section.
      ...
      ******************************************************************
      *No procedure division. É o lugar onde definimos os métodos 
      *                       para execusão do programa.
      ******************************************************************
       ...
       ENTRA-NOME.
          ...
          IF          Nome-Aluno = " "
          DISPLAY "Favor preencher o campo nome para proceguir" AT 0639
          END-IF
          EXIT.
       ...
       ENTRA-NOTA01.
            ...
            NEXT SENTENCE
            WHEN OTHER
            DISPLAY "NOTA INVALIDA, A NOTA DEVE SER DE 0 a 10." AT 0745
            PERFORM ENTRA-NOTA01
            END-EVALUATE
            EXIT.
       ...
       ENTRA-NOTA02.
            ...
            NEXT SENTENCE
            WHEN OTHER
            DISPLAY "NOTA INVALIDA, A NOTA DEVE SER DE 0 a 10." AT 0945
            PERFORM ENTRA-NOTA02
            END-EVALUATE
            EXIT.
       ...
       ENTRA-NOTA03.
            ...
            NEXT SENTENCE
            WHEN OTHER
            DISPLAY "NOTA INVALIDA, A NOTA DEVE SER DE 0 a 10." AT 1545
       ...
       CONTINUA-PROG.
              ...
              ACCEPT   CONTINUA        AT   2042 PROMPT AUTO.
              EXIT.
