      ...
      ******************************************************************
      * 6)	Programa 6 – Fatorial:  O que este programa não trata?;
      *                  Faça o mesmo programa anterior, mas aceitando
      *                  qualquer valor para variável WS-NUMERO.
      ******************************************************************
      ...
      *================================================================*
       ...
       ENTRA-NOME.
               ...
               ACCEPT  WS-NOME            AT    0633
               IF WS-NOME = " "
               DISPLAY "ENTRE COM UM NOME PARA CONTINUAR." AT 0733
               PERFORM  ENTRA-NOME
               ELSE
               DISPLAY  MENSA3            AT    0733
               END-IF
               EXIT.
